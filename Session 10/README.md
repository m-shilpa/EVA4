Target : Train a RESNET18 model to achieve accuracy of 88% in 50 epochs. Use LR Finder to find the best learning rate. Train the model using ReduceOnPlateau lr scheduler.
